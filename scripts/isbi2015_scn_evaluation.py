...
if __name__ == "__main__":
    ...
    scn_model_name = "ISBI2015_ahr_scn_val_fold2_test_fold3"
    ...
    state_dict_scn = torch.load(
        "../results/lightning_model_checkpoints/ISBI2015/ISBI2015_ahr_scn_val_fold2_test_fold3.ckpt",
        map_location="cpu",
    )["state_dict"]
    ...
    scn_model_ensemble = AdaptiveHeatmapRegression(
        ...
        ensemble=True,
        ensemble_ckpts=glob(
            "../results/lightning_model_checkpoints/ISBI2015/ensemble/ahr_SCN/*.ckpt"
        ),
        final_activation=torch.nn.ReLU(),
    )
    ...
    for i, (model, model_name) in enumerate(
        ...
        for pixel_based_sampling in pixel_based_sampling_options:
            ...
            for decoder_method in ["local_soft_argmax"]:
                ...
                save_path = f"../results/isbi2015_scn_evaluation_{model_name}_{decoder_method}.csv"
                df_results.to_csv(save_path)
    # Save all results (pickle)
    all_results["model_filename"] = scn_model_name
    save_path = f"../results/isbi2015_scn_evaluation_det_results.pkl"
